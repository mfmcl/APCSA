...
public class SnowAnimation extends Animation {
	...
	private static final int SCREEN_HEIGHT = 681;
	private static final int SCREEN_WIDTH = 940;
	...
	public SnowAnimation(int x, int aScreenHeight) {
		...
		java.net.URL imageURL = cldr.getResource("icon.gif");
	...
	public static final Image bgImg = Toolkit.getDefaultToolkit().createImage("img/bg.jpg");
